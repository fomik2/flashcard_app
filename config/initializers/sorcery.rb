...
Rails.application.config.sorcery.configure do |config|
  ...
  #
   config.twitter.key = SecretKeyManager.config('config/socnet.yml')['twitter_id']
   config.twitter.secret = SecretKeyManager.config('config/socnet.yml')['twitter_key']
   config.twitter.callback_url = "#{ SecretKeyManager.config('config/socnet.yml')['hostname'] }oauth/callback?provider=twitter"
   config.twitter.user_info_mapping = {email: "screen_name"}
  #
   config.facebook.key = SecretKeyManager.config('config/socnet.yml')['facebook_id']
   config.facebook.secret = SecretKeyManager.config('config/socnet.yml')['facebook_key']
   config.facebook.callback_url = "#{ SecretKeyManager.config('config/socnet.yml')['hostname'] }oauth/callback?provider=facebook"
